...
1. Download and extract the [tarball of the 55minutes/ninefold-example repository][tarball]; this will be the start of your new Rails project.
...
[tarball]:https://github.com/55minutes/ninefold-example/tarball/master
