NinefoldExample::Application.configure do
  ...
  config.to_prepare do
    ActionMailer::Base.postmark_settings = {
      api_key: ENV["POSTMARK_KEY"] || SECRETS.fetch(:postmark_api_key)
    }
  end
  config.action_mailer.raise_delivery_errors = true
  config.action_mailer.default_url_options = {
    host: 'ninefold-example.com',
    protocol: 'https'
  }
  ...
  config.middleware.use ExceptionNotification::Rack,
    :email => {
      ...
      :sender_address => %Q{"NinefoldExample errors" <support@ninefold-example.com>},
      :exception_recipients => %w(support@ninefold-example.com),
